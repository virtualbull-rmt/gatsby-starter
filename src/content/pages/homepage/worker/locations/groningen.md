...
quickNav:
  type: worker-cities
path: /schoonmaakwerk/groningen/
seo:
  title: Schoonmaakwerk Groningen | Vacatures Huishoudelijk Werk
  description: >-
    Zoek je schoonmaakwerk, vacatures huishoudelijk werk in Groningen? Bepaal nu
    zelf jouw tarief en kies jouw klanten in Groningen bij HomeWorks.
  keywords: 'schoonmaakwerk, Groningen, huishoudelijk werk, vacatures'
  lang: nl-NL
lead:
  headline: Schoonmaakwerk Groningen
  picture: ../../../../../../static/img/pictures/AdobeStock_233267584.jpg
  alt: Vind vacatures schoonmaakwerk in Groningen als huishoudelijke hulp
  lookingForWorker: Ik zoek een hulp
  lookingForClient: Ik zoek werk
history:
  content: >-
    HomeWorks helpt huishoudelijke hulpen in Groningen bij het vinden van werk
    bij particulieren. Onze goede ondersteuning en betrokken
    servicecoördinatoren maken samen met jou het verschil.
  ...
  propositions:
    - icon: ../../../../../../static/img/icons/noun_cleaner_1753623.svg
      ...
      description: >-
        ...
        wensen kennen, bieden we je direct de klanten in Groningen die het beste
        bij jou passen.
...
banner:
  ...
  description: >-
    Huishoudelijke hulp gezocht in Groningen? Ervaar het gemak van persoonlijke
    zorg op maat in Groningen.
  button: Vind jouw hulp
  picture: ../../../../../../static/img/pictures/AdobeStock_263806150.jpg
  alt: Vind online een betrouwbare huishoudelijke hulp in Groningen gezocht.
  url: /huishoudelijke-hulp/groningen/
introduction:
  headline: >-
    Meer weten over belasting, adressen in Groningen, verzekering en dat soort
    dingen?
  description: >-
  ...
  alt: Verzekerd werken als huishoudelijke hulp in Groningen
ourTeam:
...
feedback:
  ...
  alt: Schoonmaakwerk in Groningen
faq:
  ...
  questions:
    ...
    - question: Werkt HomeWorks ook buiten Groningen?
      answer: ' Wij werken in heel Nederland en voor alle particulieren, ook met pbg. Als er geen match is tussen u en de huidige hulpen, dan zoeken we vrijblijvend en kosteloos voor u verder.'
  button: Meer vragen?
  url: /klantenservice/
textblock:
