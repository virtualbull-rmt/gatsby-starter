...
seo:
  title: Schoonmaakwerk Alkmaar | Vacatures Huishoudelijk Werk
  description: >-
    Zoek je schoonmaakwerk, vacatures huishoudelijk werk in Alkmaar? Bepaal zelf
    jouw tarief en kies jouw klanten in Alkmaar bij HomeWorks
  keywords: 'schoonmaakwerk, Alkmaar, huishoudelijk werk'
  lang: nl-NL
lead:
  headline: 'Schoonmaakwerk, huishoudelijk werk in Alkmaar'
  picture: ../../../../../../static/img/pictures/AdobeStock_233267584.jpg
  alt: Schoonmaakwerk huishoudelijk werk in Alkmaar
  lookingForWorker: Ik zoek een hulp
  lookingForClient: Ik zoek werk
history:
  content: >-
    Sinds 1994 organiseert Home Works huishoudelijk werk en schoonmaakwerk. Door
    heel Nederland en ook in Alkmaar. Goede ondersteuning en betrokken
    service-coördinatoren maken het verschil, samen met jou! In de handige
    online app geef je op wat jij per uur wilt verdienen en kies je de klanten
    die jij wilt. Wij blijven je helpen zodat jij lekker aan de slag kan.
  ...
  propositions:
    - icon: ../../../../../../static/img/icons/noun_cleaner_1753623.svg
      ...
      description: >-
        ...
        wensen weten, bieden wij jou direct de klanten in Alkmaar die het beste
        bij jou passen.
...
banner:
  ...
  description: >-
    Huishoudelijke hulp gezocht in Alkmaar? Ervaar het gemak van persoonlijke
    zorg op maat in Alkmaar.
  button: Vind jouw hulp
  picture: ../../../../../../static/img/pictures/AdobeStock_263806150.jpg
  alt: 'Vind jouw huishoudelijke hulp in Alkmaar '
  url: /huishoudelijke-hulp/alkmaar/
introduction:
  headline: Lekker aan de slag zonder zorgen?
  description: >-
    Daar zorgt jouw helpdesk voor. Voldoende leuke klanten, gegarandeerde
    betaling en een collega op afstand die met je meedenkt en waar mogelijk
    helpt om het allemaal lekker te laten verlopen.
  button: Even kennismaken?
  picture: ../../../../../../static/img/pictures/AdobeStock_38767680.jpg
  alt: Klanten en geld voor schoonmaakwerk en huishoudelijk werk | HomeWorks
ourTeam:
