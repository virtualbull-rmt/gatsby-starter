...
quickNav:
  type: worker-cities
title: ede.md
path: /schoonmaakwerk/ede/
seo:
  title: Schoonmaakwerk Ede | Vacatures Huishoudelijk Werk
  description: >-
    Zoek je schoonmaakwerk, vacatures huishoudelijk werk in Ede? Bepaal nu zelf
    jouw tarief en kies jouw klanten in Ede bij HomeWorks.
  keywords: 'schoonmaakwerk, Ede, huishoudelijk werk, vacatures'
  lang: nl-NL
lead:
  headline: 'Schoonmaakwerk, huishoudelijk werk in Ede'
  picture: ../../../../../../static/img/pictures/AdobeStock_233267584.jpg
  alt: Vind schoonmaakwerk in Ede als huishoudelijke hulp
  lookingForWorker: Ik zoek een hulp
  lookingForClient: Ik zoek werk
history:
  content: >-
    Sinds 1994 helpt HomeWorks huishoudelijke hulpen in Ede bij het vinden van
    werk bij particulieren. Goede ondersteuning en betrokken
  ...
  propositions:
    - icon: ../../../../../../static/img/icons/noun_cleaner_1753623.svg
      ...
      description: >-
        ...
        wensen kennen, bieden we je direct de klanten in Ede die het beste bij
        jou passen.
...
banner:
  ...
  description: >-
    Huishoudelijke hulp gezocht in Ede? Ervaar het gemak van persoonlijke zorg
    op maat in Ede.
  button: Vind jouw hulp
  picture: ../../../../../../static/img/pictures/AdobeStock_263806150.jpg
  alt: Vind een huishoudelijke hulp in Ede gezocht.
  url: /huishoudelijke-hulp/ede/
introduction:
  headline: 'Meer weten over belasting, adressen in Ede, verzekering en andere zaken?'
  description: >-
  ...
  alt: Verzekerd werken als huishoudelijke hulp in Ede
ourTeam:
